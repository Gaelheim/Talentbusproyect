...
/* =====================================================
        Stored Procedure para mejor manejo de la BD
   ===================================================== */

-- Procedure para mostrar tabla de asistencias. 

CREATE PROCEDURE sp_ObtenerAsistencias
AS
BEGIN
    SET NOCOUNT ON;
...
EXEC sp_ObtenerAsistencias;

--Procedure para editar los dptos. 
...
--Sp para editar posiciones

CREATE PROCEDURE sp_EditarPosicion
    @Id INT,
    @Nombre VARCHAR(100),
...
--Sp Editar Asignaciones

CREATE PROCEDURE sp_EditarAsignacion
    @Id          INT,
    @Nombre      VARCHAR(50),
    @Porcentaje  DECIMAL(8,2),
    @Descripcion VARCHAR(200)
...
--Sp Editar Deducciones

CREATE PROCEDURE sp_EditarDeduccion
    @Id          INT,
    @Nombre      VARCHAR(50),
    @Porcentaje  DECIMAL(8,2),
    @Descripcion VARCHAR(200)
...
--SP editar asignaciones de un empleado 

CREATE PROCEDURE sp_EditarAsignacionEmpleado
    @Id                INT,
    @IdAsignacion      INT,
    @IdEmpleado        INT,
    @Tipo              TINYINT,
...
--SP eliminar asignaciones de un empleado

CREATE PROCEDURE sp_EliminarAsignacionEmpleado
    @Id INT
AS
BEGIN
    SET NOCOUNT ON;

    DELETE FROM AsignacionesEmpleado
    WHERE Id = @Id;
